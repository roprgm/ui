...
export function Input({ className, ...props }: ComponentProps<"input">) {
  return (
    <input
      className={cn(
        "h-(--size-control) w-full min-w-0 rounded-md surface-sunken px-2.5 text-foreground transition focus-ring placeholder:text-faint disabled:opacity-40 aria-[invalid=true]:ring-1 aria-[invalid=true]:ring-danger/60",
